...
CREATE DATABASE IF NOT EXISTS oceane DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
CREATE USER IF NOT EXISTS 'oceane-web'@'%' IDENTIFIED BY 'oceane-intra';
GRANT ALL PRIVILEGES ON oceane.* TO 'oceane-web'@'%';
USE oceane;
